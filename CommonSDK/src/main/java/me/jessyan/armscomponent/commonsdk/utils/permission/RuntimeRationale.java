...
public final class RuntimeRationale implements Rationale<List<String>> {
    ...
    public RuntimeRationale(String message) {
    ...
    public void showRationale(Context context, List<String> permissions, final RequestExecutor executor) {
        ...
        if (TextUtils.isEmpty(message)) {
            message = context.getString(R.string.public_message_permission_rationale, TextUtils.join("\n", permissionNames));
        } else
        ...
        new AlertDialog.Builder(context)
                ...
                .setMessage(message)
                .setPositiveButton(R.string.public_resume, new DialogInterface.OnClickListener() {
                    @Override
