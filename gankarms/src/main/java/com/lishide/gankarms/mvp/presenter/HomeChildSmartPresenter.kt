...
@FragmentScope
class HomeChildSmartPresenter @Inject
constructor(model: HomeChildSmartContract.Model,
            rootView: HomeChildSmartContract.View,
...
) : BasePresenter<HomeChildSmartContract.Model, HomeChildSmartContract.View>(model, rootView) {
